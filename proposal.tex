...
In the current implementation of {\sc Liquid}, a timing analysis is done every 5 iterations instead of each optimize-legalise iteration, because the criticality of the nets doesn't change extremely between iterations.
